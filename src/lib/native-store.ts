 ...
 *
 * В APK WebView может очищать localStorage (например, при нехватке места
 * или очистке кеша системой). Поэтому все данные дополнительно пишутся
 * в нативные Preferences — они лежат в памяти телефона и переживают перезапуск приложения.
 */
